...
// Types pour le processeur de tâches longues
type LongProcessParamsType = {
  durationMs: number;
  value1: number;
  value2: number;
  failTask?: boolean;
...
const processors: Record<string, JobProcFn> = {
  ...
  asynchronousTaskSimulatorEnhanced: doWorkSpecific as JobProcFn<
