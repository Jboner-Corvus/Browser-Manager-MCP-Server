...
import { TASK_QUEUE_NAME, DEAD_LETTER_QUEUE_NAME, DEFAULT_BULLMQ_JOB_OPTIONS, } from './utils/constants.js';
...
taskQueueEvents.on('error', (err) => logger.error({ err, queue: TASK_QUEUE_NAME }, "Erreur de la file d'attente principale"));
deadLetterQueueEvents.on('error', (err) => logger.error({ err, queue: DEAD_LETTER_QUEUE_NAME }, 'Erreur de la Dead Letter Queue'));
