...
const StatusApp = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "app-container", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "content-wrapper", children: [
    status.isConnected && status.connectedTab ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "tab-section-title", children: "Page avec client MCP connecté:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        TabItem,
        {
          tab: status.connectedTab,
          button: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "primary", onClick: disconnect, children: "Déconnecter" }),
          onClick: openConnectedTab
        }
      ) })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "status-banner", children: "Aucun client MCP n'est actuellement connecté." }),
